...
const FIRSubmission = () => {
  ...
  const renderRejectedFIRs = () => {
    return firs
      .filter((fir) => fir.status === "Rejected")
      .map((fir) => (
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        {/* Submitted FIRs List */}
        <div className="mt-12">
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-3xl font-extrabold text-left mb-6 sm:mb-8 mt-6 sm:mt-8 font-serif italic tracking-wide">Rejected Cases</h2>
          {loading ? (
