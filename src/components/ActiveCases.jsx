  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-7xl mx-auto bg-white rounded-lg shadow-md p-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-6">Active Cases</h1>
                    ...
                    <div className="text-gray-500">
                      {cases.length === 0 ? (
                        <>
                          ...
                          <p className="text-sm mt-1">All cases have been processed or none have been Active yet.</p>
                        </>
                      ) : (
                        <>
