      ...
      try {
        ...
        try {
          ...
          if (casesSnapshot.empty) {
            console.log('No UnSolved cases found in database');
            setCases([]);
            return;
          }
          ...
          casesSnapshot.forEach((doc) => {
            ...
            const data = doc.data();
            if (!data.status || data.status !== 'UnSolved') {
          ...
          if (queryError.code === 'failed-precondition') {
            ...
            setCases(casesData);
            toast.info('Displaying UnSolved cases');
          } else {
            throw queryError;
          }
        }
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[300px]">
        ...
        <p className="mt-4 text-gray-600">Loading UnSolved cases...</p>
      </div>
    );
  }
    ...
    return (
      <div className="p-6 bg-red-50 rounded-lg">
        ...
        <p className="mt-2 text-red-600">
          This query requires a Firestore index. Please create it to view UnSolved cases properly.
        </p>
        {errorLink && (
          <a 
            href={errorLink} 
