...
function Header() {
  ...
  >
    ...
    <span className="font-bold text-[10px] sm:text-xs">Signup</span>
  ...
  {isDropdownOpen && (
    <div className="absolute right-0 mt-2 w-40 sm:w-48 bg-white border border-gray-300 rounded-lg shadow-xl overflow-hidden z-50 transition-opacity duration-300">
      ...
      >
        ...
        <span className="text-[10px] sm:text-xs">Signup as a User</span>
      </Link>
      <Link 
      ...
      >
        ...
        <span className="text-[10px] sm:text-xs">Signup as an Investigator</span>
      </Link>
    </div>
  )}
</div>
