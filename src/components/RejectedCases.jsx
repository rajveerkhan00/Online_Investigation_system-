      ...
      try {
        ...
        casesSnapshot.forEach((doc) => {
          ...
          casesData.push({ 
            id: doc.id, 
            ...data,
            rejectedReason: data.rejectedReason || 'No reason provided' // Add rejectedReason field
          });
  ...
  const filteredCases = React.useMemo(() => {
    return sortedCases.filter((fir) => {
      ...
      return (
        ...
        (fir.rejectedReason?.toLowerCase().includes(searchLower))
      );
    });
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-7xl mx-auto bg-white rounded-lg shadow-md p-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-6">Rejected Cases</h1>
                  ...
                  return (
                    <tr key={fir.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 max-w-xs truncate">
                        {fir.rejectedReason || 'No reason provided'}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                ...
                <tr>
                  <td colSpan="8" className="px-6 py-8 text-center">
                    <div className="text-gray-500">
                      {cases.length === 0 ? (
                        <>
                          <p className="font-medium">No rejected cases found</p>
                          <p className="text-sm mt-1">All cases have been processed or none have been rejected yet.</p>
                        </>
                      ) : (
                        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="mb-2">
                  ...
                  <dd className="mt-1 text-sm font-semibold text-red-600">Rejected</dd>
                </div>
                <div className="mb-2">
                  <dt className="text-sm font-medium text-gray-500">Rejection Reason</dt>
                  <dd className="mt-1 text-sm text-gray-900">
                    {selectedFIR.rejectedReason || 'No reason provided'}
                  </dd>
                </div>
              </div>
            </div>
